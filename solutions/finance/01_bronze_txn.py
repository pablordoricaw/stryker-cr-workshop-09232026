...
# MAGIC `databricks-sdk` (for the `databricks.sdk.service.postgres` Lakebase CDF module). It is
...
# MAGIC | **domain** | Finance (locked to this solution) | Never, it selects the Finance transactional schema |
